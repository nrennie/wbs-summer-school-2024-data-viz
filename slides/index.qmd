...
[How did the Royal Statistical Society’s Best Practices for Data Visualisation guide start?]{.fragment}
...
![](images/andreas.png){fig-align="left" fig-alt="Photo of Andreas" width=70%}

<small>Andreas Krause, Idorsia Pharmaceuticals</small>

:::

::: {.column width="30%"}

![](images/nicola.jpg){fig-align="left" fig-alt="Photo of Nicola" width=70%}

<small>Nicola Rennie, Lancaster University</small>

:::

::: {.column width="30%"}

![](images/brian.png){fig-align="left" fig-alt="Photo of Brian" width=70%}

<small>Brian Tarran, Royal Statistical Society</small>
